...
// CSP_CONNECT_DOMAIN 用于覆盖 connect-src 中的 wss 通配符域名后缀。
// 当 API_BASE_URL 含有非标准前缀（如 "-tweb.example.com"）导致 wss://*<API_BASE_URL>
// 不符合 CSP 通配符规范时，单独用 CSP_CONNECT_DOMAIN 指定合法的后缀（如 ".example.com"）。
